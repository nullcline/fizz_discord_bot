...
class MusicCog(commands.Cog):
    ...
    @commands.command(aliases=['p'], brief='Plays a Youtube link or YT search query if its <10 m')
    ...
    @commands.command(aliases=['replay','restart'], brief='Repeats the last video from play')
    ...
    @commands.command(aliases=['j', 'joi'], brief='Joins the voice channel that you\'re in')
